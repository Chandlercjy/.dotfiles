...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("format-all-" "shfmt" "sqlformat" "swiftformat" "rufo" "rustfmt" "perltidy" "prettier" "ocp-indent" "mix-format" "ktlint" "html-tidy" "gofmt" "elm-format" "emacs-lisp" "define-format-all-formatter" "dfmt" "clang-format" "crystal" "black" "brittany" "asmfmt")))
